...
export const about: AboutContent = {
  ...
  sidebarLabel: "Corbin Meier: Est. 2016",
  sidebarQuote:
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Today, I specialize in building sophisticated web applications for startups and scaling businesses. I bridge the gap between complex backend logic and elegant, user-centric frontend experiences. Don't believe me? Check out my projects to see the results of my work!",
      ],
    },
  ],
  closingSection: {
